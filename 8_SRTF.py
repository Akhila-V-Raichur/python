class SRTF:
    def processData(self, no_of_processes):
        ...
        SRTF.schedulingProcess(process_data)
        ...
        while 1:
            ...
            if len(ready_queue) == 0:
                ...
                if process_data[k][2] == 0:        #If Burst Time of a process is 0, it means the process is completed
                    process_data[k][3] = 1
                    process_data[k].append(e_time)
        t_time = SRTF.calculateTurnaroundTime(process_data)
        w_time = SRTF.calculateWaitingTime(process_data)
        SRTF.printData(process_data, t_time, w_time, sequence_of_process)
